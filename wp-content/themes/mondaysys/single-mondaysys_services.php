...
if ( have_posts() ) {
  while ( have_posts() ) {
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
        ...
        <section class="border-container left-square-bg border-top">
                ...
                <div class="section-column">
                    ...
                    <?php endif; // End Service Solutions ?>
        ...
        <section class="border-container">
            ...
            <div class="section-column border-top">
                ...
                <div class="service_benifites">
                    <div class="grid-row border-top section-spacing" style="--desk-col:1fr 1fr; --tab-col:1fr; --mob-col:1fr">
                        <div class="empty"></div>
                        <?php 
                ...
                </div><!--End Service Benifites-->

                <div class="service_capabilities">
                    <div class="grid-row border-top section-spacing" style="--desk-col:1fr 1fr;  --mob-col:1fr; --tab-col:1fr;">
                        <?php 
